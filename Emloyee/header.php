        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="http://localhost/HR_Management/Emloyee" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Trang chủ</a>
                    <div class="nav-item dropdown">
                        <a href="http://localhost/HR_Management/Emloyee/information.php" class="nav-link"><i class="fa fa-user me-2"></i>Thông tin cá nhân</a>
                    </div>
                    <a href="http://localhost/HR_Management/Emloyee/attendance.php" class="nav-link"><i class="fa fa-calendar-days me-2"></i>Chấm công</a>
                    <a href="http://localhost/HR_Management/Emloyee/salary.php" class="nav-item nav-link"><i class="fa fa-dollar me-2"></i>Lương</a>
                    <a href="http://localhost/HR_Management/Emloyee/notify.php" class="nav-item nav-link"><i class="fa fa-bell me-lg-2"></i>Thông báo</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
